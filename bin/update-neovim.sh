...
NVIM_BRANCH="${NVIM_BRANCH:-master}"
NVIM_SOURCE_DIR="${NVIM_SOURCE_DIR:-${HOME}/Workspace/neovim/neovim}"
NVIM_PREFIX="${NVIM_PREFIX:-/usr/local/Cellar/neovim}"
NVIM_NUM_COMMITS="${NVIM_NUM_COMMITS:-15}"
NVIM_NUM_JOBS="${NVIM_NUM_JOBS:-$(nproc 2>/dev/null || sysctl -n hw.ncpu)}"
