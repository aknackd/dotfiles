...
if utils.has_feature("lsp") == false then
	return
end
...
lsp_zero.on_attach(function(client, bufnr)
	...
	vim.keymap.set(
		...
		"<leader>gr",
		vim.lsp.buf.rename,
		utils.mergetable(opts, { desc = "Rename variable/function/method under cursor" })
	)
	vim.keymap.set(
		"n",
		"<leader>e",
		vim.diagnostic.open_float,
		utils.mergetable(opts, { desc = "Open floating diagnostic message" })
	)
	vim.keymap.set(
		"n",
		"<leader>q",
		vim.diagnostic.setloclist,
		utils.mergetable(opts, { desc = "Open diagnostic list" })
	)
